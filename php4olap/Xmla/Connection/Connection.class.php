...
*/
namespace php4olap\Xmla\Connection;

use php4olap\Xmla\Connection\Adaptator\AdaptatorException;

use php4olap\Xmla\Metadata\Database;
use php4olap\Xmla\Metadata\Catalog;
use php4olap\Xmla\Metadata\Schema;
use php4olap\Xmla\Metadata\ResultSet;
...
{	
     ...
     */
	function __construct($soapAdaptator, Array $restrictions = null)
	{
	...
	public function findDatabases(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Database');
	}
	...
	public function findCatalogs(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Catalog');
	}
	...
	public function findSchemas(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		try{
		    ...
		    return $this->hydrate($result, 'php4olap\Xmla\Metadata\Schema');
	...
	public function findCubes(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Cube');
	}
	...
	public function findDimensions(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Dimension');
	}	
	...
	public function findHierarchies(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Hierarchy');
	}
	...
	public function findLevels(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Level');
	}
	...
	public function findMembers(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Member');
	}
	...
	public function findMeasures(Array $propertyList = null, Array $restrictionList = null)
	{
		...
		return $this->hydrate($result, 'php4olap\Xmla\Metadata\Measure');
	}
