...
namespace php4olap\Tests\Xmla\Metadata;

use php4olap\Xmla\Metadata\Hierarchy;
...
class HierarchyTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testHydrate()
	{
		...
		$connection = $this->getMock('php4olap\Xmla\Connection\Connection', array(), array(), '', FALSE);
